...
//you need this for history to work
...
class EditProfile extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (nextProps.profile.profile) {
      ...
      // Bring skills array back to CSV (I didn't use this)
  ...
  onSubmit = e => {
    ...
    // history comes from withrouter from react-router-dom
